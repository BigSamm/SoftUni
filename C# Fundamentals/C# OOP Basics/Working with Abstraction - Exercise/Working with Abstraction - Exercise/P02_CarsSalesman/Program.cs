...
namespace P02_CarsSalesman
{
    class CarSalesman
    {
        ...
        {
            List<Engine> engines = ParseEngines();

            List<Car> cars = ParseCars(engines);
        ...
        private static List<Car> ParseCars(List<Engine> engines)
        {
        ...
        private static List<Engine> ParseEngines()
        {
